...
require (
	...
	github.com/kubernetes-csi/csi-lib-utils v0.9.2-0.20210706123018-04402755ac45
	github.com/kubernetes-csi/csi-test/v4 v4.2.1-0.20210614212600-3de1c6c206a9
	...
	kubevault.dev/operator v0.4.0-rc.0
)
